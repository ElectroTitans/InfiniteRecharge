...
public class GripPipeline implements VisionPipeline{
	...
	public void process(Mat source0) {
		// Step HSV_Threshold0:
		input = source0;
		Imgproc.resize( source0, source0, new Size(source0.cols() / 3, source0.rows() / 3));
		Mat hsvThresholdInput = source0;
		double[] hsvThresholdHue = {63.12949640287769, 107.81569965870308};
		double[] hsvThresholdSaturation = {155.93525179856115, 255.0};
		double[] hsvThresholdValue = {100.89928057553956, 163.61774744027306};
		...
		double[] filterContoursSolidity = {45.86330935251798, 100};
